...
Curated YouTube channels, playlists, and individual videos covering Flipper Zero features, attack techniques, hardware teardowns, and protocol deep-dives.

## Legend

- **Name** — video or series title
- **URL** — channel or playlist URL
- **Author** — creator or channel name
- **Stars** — approximate view count
- **Last Commit** — year of publication or most recent upload
- **License** — content license where applicable
...
|------|-----|--------|-------|-------------|---------|--------|-------|
| "Flipper Zero in 100 Seconds" | https://www.youtube.com/watch?v=nLIp4wd0oXs | Fireship | ~2M views | 2023 | N/A | active | Viral short intro (2M+ views) |
| David Bombal Flipper series | https://www.youtube.com/playlist?list=PLhfrWIlLOoKNDieM73gRqTSYWQXhP3OYE | David Bombal | ~1M views | 2023 | N/A | active | Multi-part Flipper tutorial series |
| "Hacking Cars with $200 Device" | https://www.youtube.com/watch?v=JkJwi1W1Wgk | NetworkChuck | ~3M views | 2023 | N/A | active | Sub-GHz vehicle RKE exploration |
| "Flipper Zero BadUSB Attacks" | https://www.youtube.com/watch?v=DekPNgmDQ3g | John Hammond | ~500k views | 2023 | N/A | active | BadUSB attack walkthrough |
| NFC/RFID hacking series | https://www.youtube.com/@stacksmashing | stacksmashing | ~200k views | 2023 | N/A | active | Deep-dive NFC/RFID attack series |
| HackerShack Flipper series | https://www.youtube.com/@HackerShack | HackerShack | ~100k views | 2023 | N/A | active | Comprehensive feature walkthrough |
...
| NFC relay attack demo | https://www.youtube.com/watch?v=nfc_relay | community | N/A | 2024 | N/A | active | Two-Flipper NFC relay attack demo |
...
- [Tutorials, How-Tos & Wikis](guides.md)
- [Courses & Books](courses.md)
- [CTF Challenges & Badge Firmware](ctf.md)
