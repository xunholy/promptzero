...
var irRawDecodeSpec = Spec{
	...
	Description: "Decode a raw infrared timing capture (the space-separated microsecond mark/space " +
		...
		"Decodes NEC, Kaseikyo (Panasonic/Denon/JVC/Sharp/Mitsubishi), Samsung32, Sony SIRC, and Philips RC5/RC5X, dispatched by the leader pulse (NEC ~9000µs, Kaseikyo ~3456/1728µs, Samsung " +
